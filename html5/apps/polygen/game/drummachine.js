class Drummachine
{
    ...
    oneTimeInit()
    {
        ...
        let cellSize = new Size(30,60);
        let tracks = ["CLAP", "CLAVES", "CLOSED HAT","HAT", "CRASH", "RIDE","FX","SHAKER","TOM","SNARE","KICK 2","KICK 1"];

        for(let i=0;i<tracks.length;i++)
        {
            this.tracks.push(new Sequencer(max_seq_length, new Vector2(10, 20+(i*(cellSize.h+2))), cellSize, tracks[i]));
        }
    }
    ...
    update()
    {
        ...
        {
            this.masterVol.text = Math.floor(this.masterVolume.value * 100).toString()+'%';
            ...
            GAZCanvas.Text(22, "Volume", pos, '#000000', 'center',this.textStyle);
        }

        //ditto for the tempo dial
        {
            this.masterTempo.text = this.bpm.toFixed(0);
            ...
            GAZCanvas.Text(22, "Tempo", pos, '#000000', 'center',this.textStyle);
        }
